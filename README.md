...
| Documento | Descrição |
| --- | --- |
| [Concepção do Projeto](./docs/concepcao.md) | Apresenta a identidade da startup, o problema e sua motivação, o impacto social esperado, o esboço conceitual da solução e as referências utilizadas. |

Novos documentos técnicos serão adicionados conforme as decisões de arquitetura, integração e implementação forem definidas.
